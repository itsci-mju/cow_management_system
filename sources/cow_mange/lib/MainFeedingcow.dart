...
import 'package:cow_mange/ListFeeding.dart';
...
class Feedingcow extends StatefulWidget {
  final Employee? emp;
  final List<Cow> cow;
  const Feedingcow({Key? key, this.emp, required this.cow}) : super(key: key);

  @override
  State<Feedingcow> createState() => _FeedingcowState();
}

class _FeedingcowState extends State<Feedingcow> {
  String query = "";
  List<Cow> listcow = [];
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () {
            ...
            Navigator.of(context).push(MaterialPageRoute(builder: ((context) {
              return AddFeedingcow(cow: listcow, emp: widget.emp);
            })));*/
          },
          label: const Text(
            "เพิ่มข้อมูล",
