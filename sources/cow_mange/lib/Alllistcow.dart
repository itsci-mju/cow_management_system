...
class Alllistcow extends StatefulWidget {
  final Employee? emp;
  final List<Cow> cow;
  const Alllistcow({
    Key? key,
  ...
  @override
  State<Alllistcow> createState() => _mywidwaState();
}

class _mywidwaState extends State<Alllistcow> {
  String query = "";
  List<Cow> listcow = [];
                  ...
                  decoration: InputDecoration(
                    focusedBorder: OutlineInputBorder(
                      ...
                      borderSide: const BorderSide(
                        color: Color.fromARGB(255, 6, 48, 17),
                      ),
                    ),
                    hintText: "ค้นหาโค",
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () {
            Navigator.of(context).push(MaterialPageRoute(builder: ((context) {
              return Register_Cow(
                  //id_farm: widget.cow[0].farm!.id_Farm.toString(),
                  emp: widget.emp);
            })));
          },
          label: const Text(
