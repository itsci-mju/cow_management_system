...
class Drawer_Filter_Progress extends StatefulWidget {
  final Employee emp;
  final List<Cow> cow;
  const Drawer_Filter_Progress({
    Key? key,
    required this.emp,
    required this.cow,
  }) : super(key: key);
  ...
  @override
  State<Drawer_Filter_Progress> createState() => _Drawer_Filter_ProgressState();
}
...
class _Drawer_Filter_ProgressState extends State<Drawer_Filter_Progress> {
                  ...
                  children: [
                    ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                          minimumSize: const Size(50, 50), backgroundColor: Colors.orange),
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    String t = widget.emp.farm!.id_Farm.toString();
                    setState(() {
                      //idfarm
                    ...
                    final listcow = await fitterCow(ft);
                    setState(() {
                      Age1.text = "";
                      Age2.text = "";
                    });
