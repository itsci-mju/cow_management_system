...
class Progresscow extends StatefulWidget {
  final Employee? emp;
  final List<Cow> cow;
  const Progresscow({Key? key, this.emp, required this.cow}) : super(key: key);

  @override
  State<Progresscow> createState() => _ProgresscowState();
}

class _ProgresscowState extends State<Progresscow> {
  String query = "";
  List<Cow> listcow = [];
        ...
        child: FloatingActionButton.extended(
          ...
          onPressed: () {
            ...
            Navigator.of(context).push(MaterialPageRoute(builder: ((context) {
              return AddProgress(cow: listcow, emp: widget.emp);
            })));
          */
          },
          label: const Text(
